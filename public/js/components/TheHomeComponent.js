    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 order-1 order-md-2 col-md-9 media-container">
                <video v-if="currentMediaDetails.movies_trailer" autoplay controls muted :src="'video/' + currentMediaDetails.movies_trailer" class="fs-video"></video>
            </div>
        </div>
        ...
        <div class="row"> <!-- 2-up for nav and media info -->
            ...
            <div class="col-12 col-sm-9 media-info">
                ...
                <div class="thumb-wrapper clearfix">
                    <img v-for="media in retrievedMedia" :src="'images/video/' + media.movies_cover" alt="media thumb" class="img-thumbnail rounded float-left media-thumb" @click="clickCurrentMedia(media)">
                </div>
            </div>       
